...
description: >
  ...
  (ChatGPT, Codex, Perplexity, Gemini, Google AI Overviews) while maintaining
...
3. Execute the PDF generator: `~/.Codex/skills/geo/scripts/generate_pdf_report.py data.json GEO-REPORT.pdf`
